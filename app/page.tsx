    ...
    <div className="flex flex-col gap-y-10 items-center">
      ...
      <div className="flex">
        <div className="relative w-44 h-44">
          <Image src={developerAssociateLogo} alt="AWS Developer Associate Ceritfication Icon" fill />
        </div>

        <div className="relative grow w-44 h-44">
          <Image src={architectAssociateLogo} alt="AWS Solution Architect Associate Ceritfication Icon" fill />
        </div>
      </div>
